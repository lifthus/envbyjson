...
exports.loadProp = exports.load = void 0;
...
const load = (...paths) => {
    ...
    for (const path of paths) {
        ...
        const jsonFile = fs_1.default.readFileSync(path, "utf8");
...
const envjson = {
    load: exports.load,
    loadProp: exports.loadProp,
};
exports.default = envjson;
